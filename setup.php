...
$users = [
    ...
    ['maria',      'Maria Gonzalez',   'maria@westsideclinic.org',        '801-555-0201', 'Westside Community Clinic',        'community'],
    ['rosa',       'Rosa Mendez',      'rosa@ogdencenter.org',             '801-555-0202', 'Ogden Community Center',           'community'],
    ['linda',      'Linda Ortiz',      'linda@southjordanhealth.org',      '801-555-0203', 'South Jordan Health Alliance',     'community'],
    ['carmen',     'Carmen Reyes',     'carmen@saltlakeparent.org',        '801-555-0204', 'Salt Lake Parent Resource Center', 'community'],
    ['sofia',      'Sofia Ramirez',    'sofia@kearnsrec.org',              '801-555-0205', 'Kearns Recreation Center',         'community'],
    ['david',      'David Park',       'david@slcschools.org',             '801-555-0206', 'SLC School District',              'community'],
    ['tom',        'Tom Baker',        'tom@herrimanrec.org',              '801-555-0207', 'Herriman Recreation Center',       'community'],
    ['patricia',   'Patricia White',   'patricia@murrayfamilyclinic.org',  '801-555-0208', 'Murray Family Clinic',             'community'],
    ['james.lee',  'James Lee',        'james.lee@westvalleycommunity.org','801-555-0209', 'West Valley Community Center',     'community'],
    ['angela',     'Angela Moore',     'angela@holladaywellness.org',      '801-555-0210', 'Holladay Wellness Coalition',      'community'],
    // 5 Internal staff (James persona)
    ['james',      'James Thompson',   'james@imail.org',                  '801-555-0101', 'Intermountain Healthcare',         'staff'],
    ['emily',      'Emily Harris',     'emily@imail.org',                  '801-555-0102', 'Intermountain Healthcare',         'staff'],
    ['michael',    'Michael Clark',    'michael@imail.org',                '801-555-0103', 'Intermountain Healthcare',         'staff'],
    ['jessica',    'Jessica Wang',     'jessica@imail.org',                '801-555-0104', 'Intermountain Healthcare',         'staff'],
    ['kevin',      'Kevin Turner',     'kevin@imail.org',                  '801-555-0105', 'Intermountain Healthcare',         'staff'],
    // 3 Admins (Sarah persona)
    ['sarah',      'Sarah Johnson',    'sarah@childrenshealth.org',        '801-555-0301', "Children's Health Community",      'admin'],
    ['rachel',     'Rachel Kim',       'rachel@childrenshealth.org',       '801-555-0302', "Children's Health Community",      'admin'],
    ['mark',       'Mark Davis',       'mark@childrenshealth.org',         '801-555-0303', "Children's Health Community",      'admin'],
    // 3 Leaders (Dr. Chen persona)
    ['dr.chen',    'Dr. Linda Chen',   'dr.chen@childrenshealth.org',      '801-555-0401', "Children's Health — Leadership",   'leader'],
    ['dr.patel',   'Dr. Raj Patel',    'dr.patel@childrenshealth.org',     '801-555-0402', "Children's Health — Leadership",   'leader'],
    ['dr.nguyen',  'Dr. Anh Nguyen',   'dr.nguyen@childrenshealth.org',    '801-555-0403', "Children's Health — Leadership",   'leader'],
];
...
<div class="container">
    <div class="card" style="max-width:700px; margin:40px auto;">
        ...
        <div class="alert alert-info">
            Default password for all accounts: <strong>pass123</strong>
        </div>
        <div class="table-wrapper">
            <table>
                <thead>
                    <tr><th>Username</th><th>Role</th><th>Full name</th></tr>
                </thead>
                <tbody>
